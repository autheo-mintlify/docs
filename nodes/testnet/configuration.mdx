...
This guide walks through deploying a production Autheo Chain validator. Complete [Prerequisites](/nodes/testnet/node-setup), [Installation](/nodes/testnet/installation), [Key management](/nodes/testnet/key-management), and [License setup](/nodes/testnet/license-setup) before continuing.
