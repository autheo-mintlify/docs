...
This guide walks through submitting `MsgCreateValidator` on Autheo Chain. Complete [Prerequisites](/nodes/testnet/node-setup), [Installation](/nodes/testnet/installation), [Key management](/nodes/testnet/key-management), [License setup](/nodes/testnet/license-setup), and [Production deployment](/nodes/testnet/configuration) before starting.
