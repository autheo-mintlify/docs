...
1. Review [Prerequisites](/nodes/testnet/node-setup)
2. [Install the binary](/nodes/testnet/installation)
3. Configure [key management](/nodes/testnet/key-management)
4. Complete [NFT license setup](/nodes/testnet/license-setup)
5. Follow the [production deployment](/nodes/testnet/configuration) guide
