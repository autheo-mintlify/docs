...
If you already have a wallet (MetaMask, Keplr, or any BIP-39 wallet), you can import it using its mnemonic. Only do this if you understand the risk: entering a mnemonic on a server exposes it to that environment.
