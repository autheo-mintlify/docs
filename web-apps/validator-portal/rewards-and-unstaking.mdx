...
<Steps>
  ...
  <Step title="Claim from the delegation row">
    ...
    <img src="/images/vp-claim-rewards-1.png" alt="Delegation page with Claim Rewards button highlighted" />
  </Step>
  <Step title="Sign in Keplr">
    Sign the transaction in Keplr. Rewards transfer to your wallet upon confirmation.

    <img src="/images/vp-claim-rewards-2.png" alt="Claim rewards — Keplr signing prompt" />
    <img src="/images/vp-claim-rewards-3.png" alt="Claim rewards — transaction confirmed" />
  </Step>
</Steps>
...
<Steps>
  <Step title="Open the unstake flow">
    ...
    <img src="/images/vp-unstake-1.png" alt="Delegation page with Unstake button highlighted" />
  </Step>
  <Step title="Enter the amount">
    Enter the THEO amount to unstake, or click **MAX** to unstake your full delegated amount.

    <img src="/images/vp-unstake-2.png" alt="Unstake amount input modal" />
  </Step>
  <Step title="Confirm and sign">
    Click **Confirm** and sign the transaction in Keplr.

    <img src="/images/vp-unstake-3.png" alt="Unstake transaction confirmed in Keplr" />
  </Step>
</Steps>
