...
![Dashboard with Deploy Your Node button highlighted](/images/vp-deploy-node.png)
...
<Steps>
  ...
  <Step title="Deploy and complete checkout">
    ...
    <img src="/images/vp-deploy-checkout-1.png" alt="Node deployment configuration — step 1" />
    <img src="/images/vp-deploy-checkout-2.png" alt="Node deployment configuration — step 2" />
    <img src="/images/vp-deploy-checkout-3.png" alt="Node deployment configuration — step 3" />
    <img src="/images/vp-deploy-checkout-4.png" alt="Stripe checkout for node subscription" />
    <img src="/images/vp-deploy-checkout-5.png" alt="Node provisioning status after checkout" />
  </Step>
