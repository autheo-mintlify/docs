...
```bash
# Initial request
curl "https://testnet-explorer.autheo.com/api/v2/addresses/0x<address>/transactions"

# Next page — pass the params from next_page_params
curl "https://testnet-explorer.autheo.com/api/v2/addresses/0x<address>/transactions?block_number=12345&index=10&items_count=50"
```
