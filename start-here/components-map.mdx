...
| Operator key | Signs all on-chain transactions (`eth_secp256k1`) | [Key management](/nodes/testnet/key-management) |
| Consensus key | Signs block proposals (Ed25519) | [Key management](/nodes/testnet/key-management) |
...
| Testnet EVM explorer | `https://evm-explorer.autheo.com/` |
| Testnet Cosmos explorer | `https://cosmos.autheo.com` |
