...
| Term | Definition |
|---|---|
| **Chain ID (Cosmos)** | `autheo_785-1` — used in all CLI `--chain-id` flags |
| **Chain ID (EVM)** | `785` — used when adding the network to MetaMask or ethers.js |
| **`autheod`** | The Autheo Chain node binary (current version: 1.0.8) |
