...
keywords: ["deployment", "checklist", "mainnet", "pre-launch", "verification", "smart contract"]
---
...
- [ ] Contract verified on the [block explorer](https://testnet-explorer.autheo.com/) (upload ABI/source)

## Network settings

- [ ] Deployment script targets `autheoTestnet` network config
- [ ] `chainId: 785` set in Hardhat/Foundry config
