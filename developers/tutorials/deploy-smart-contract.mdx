---
title: 'Deploying a smart contract on the Autheo blockchain'
---
...
3. Enter the following information for the Autheo blockchain:
  * Network name: Autheo
  * New RPC URL: `https://rpc1.autheo.com` (mainnet) or `https://testnet-rpc1.autheo.com` (testnet)
  * Chain ID: `2127` (mainnet) or `785` (testnet)
...
3. Copy your OpenZeppelin code into the file.
  ...
  <Accordion title="Example ERC20 contract code">
