...
```bash
curl -X POST https://testnet-rpc1.autheo.com \
...
<Note>
WebSocket connections are required for real-time subscriptions. Use `wss://testnet-rpc1.autheo.com:8546` instead of the HTTP endpoint.
</Note>
