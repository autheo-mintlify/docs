...
<Steps>
  ...
  <Step title="Verify receipt">
    After ~5 seconds (one block), your MetaMask balance will update. You can also confirm receipt on the [block explorer](https://testnet-explorer.autheo.com/) by searching your address.
  </Step>
</Steps>
